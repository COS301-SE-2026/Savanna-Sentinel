...
test.describe("Registration Flow", () => {
    ...
    test("Successful registration shows pending activation screen", async ({page}) => {
    ...
    test("Submitting existing email or username displays correct error banner", async ({page}) => {
        const testTimestamp = `${Date.now()}_1`;
        const testEmail = `automation_w${workerId}_${testTimestamp}@example.com`;
        const testUsername = `ranger_w${workerId}_${testTimestamp}`;
