      ...
      <div className="min-h-screen flex flex-col md:flex-row">
        ...
        <div className="flex-1 flex flex-col items-center justify-center bg-brand-navy md:bg-background px-6 py-10">
          ...
          <div className="w-full max-w-[320px] text-center">
            ...
            <Link to="/login" className="text-sm text-white md:text-primary hover:underline">
              Back to Login
            </Link>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-brand-navy md:bg-background px-6 py-10">
        ...
        <div className="w-full max-w-[320px]">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor="requested_role" className={labelClass}>Role</Label>
              <Select onValueChange={(val) => setValue("requested_role", val as RegisterFormValues["requested_role"], { shouldValidate: true })}>
                <SelectTrigger
                  id="requested_role"
                ...
                <SelectContent>
                  ...
                  <SelectItem value="community_liaison">Community Liaison</SelectItem>
                </SelectContent>
              </Select>
              {errors.requested_role && <p className={errorClass}>{errors.requested_role.message}</p>}
            </div>
          ...
          <p className="mt-7 text-center text-xs text-white/80 md:text-muted-foreground">
            ...
            <Link to="/login" className="hover:underline text-white md:text-primary">
              Log in
            </Link>
          </p>
