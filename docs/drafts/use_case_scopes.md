...
#### Image
![Risk Subsystem](sav_sent_use_cases_risk_light.png)

#### Use Case Scope
| Use Case Number | Starts With/Ends With |
| --------------- | --------------------- |
| UC3.1 View Generated Risk Heatmap | TUCBW the user enterring the map screen. <br /> TUCEW the user being presented the most recent heatmap their role permits generated by the AI risk engine |
...
#### Image
![Field Subsystem](sav_sent_use_cases_field_light.png)
...
| UC4.2 Edit Field Report | TUCBW the user selecting a pending, unploaded, submitted field report. <br /> TUCEW the pending field report being updated and the user being notified. |
