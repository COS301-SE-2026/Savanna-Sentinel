...
from app.repositories.route_repository import build_park_graph, find_nearest_node
...
def run_route_planning_job(
    ...
    """Loads ParkGraph, calls plan_routes(), and returns however many
    PlannedRoute alternatives were actually accepted.
    ...
    routes = plan_routes(
        ...
        max_time_min, max_fuel_l, num_alternatives, ACOConfig(),
    )
